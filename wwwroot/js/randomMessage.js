...
(function () {
    ...
    const phrases2 = ["an elephant", "a serial killer", "a clock", "an escaped prisoner", "an Avon salesman", "a bartender", "a King", "a Princess", "a secret agent", "a frog", "a sexually-energised priest", "a harsh critic"];
    ...
    const phrases4 = ["a bank.", "a zoo.", "a house.", "a shed.", "a bridge.", "a helicopter.", "a prison.", "a treehouse.", "a television programme.", "a glass bottle.", "a pirate."];
    ...
    for (let i=0; i<5; i++){
        ...
        switch (i){
            case 0:
                ...
                break;
            case 1:
                currentList = phrases2;
                break;
            case 2:
                currentList = phrases3;
                break;
            case 3:
                currentList = phrases4;
                break;
            case 4:
